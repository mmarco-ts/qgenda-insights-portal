...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    description: 'This year — coverage and fill ops',
    dateRangeDays: 365,
    dateRangeLabel: 'Last 365 days',
    prompts: [
      'Open shifts trend over the last 12 months',
      'Published rate % by task type this year',
      'Total shifts vs open shifts by month',
      'Which task types have the most open shifts?',
      'Open shifts by organization over the last 12 months',
    ],
  },
  {
    id: 'ops',
    name: 'Operations Lead',
    description: 'This month — task-level execution',
    dateRangeDays: 30,
    ...
    prompts: [
      ...
      'Top task types by total shifts this month',
